...
//
//    public final static EntityBaseSerializer instance = new EntityBaseSerializer(EntityBase
//    .class);
//
//    private final List<Class<? extends Annotation>> IGNORE_ANNOTATIONS =
//            Arrays.asList(ElementCollection.class, OneToMany.class, OneToOne.class,
//                    ManyToOne.class, ManyToMany.class, Embedded.class);
//
...
//
//    @Override
//    public void serialize(EntityBase value, JsonGenerator gen, SerializerProvider provider)
//    throws IOException {
...
//    }
//
//    private Map<String, Object> invokeGetter(EntityBase value, Class<? extends EntityBase> aClass
...
//                        if (getter.equals(declaredMethod.getName()) || is.equals(declaredMethod
//                        .getName())) {
